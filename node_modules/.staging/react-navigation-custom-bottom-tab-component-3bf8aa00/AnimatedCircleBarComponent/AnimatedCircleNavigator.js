...
var AnimatedCircleNavigator = /** @class */ (function (_super) {
    __extends(AnimatedCircleNavigator, _super);
    function AnimatedCircleNavigator(props) {
    ...
    AnimatedCircleNavigator.prototype.shouldComponentUpdate = function (nextProps, nextState) {
    ...
    AnimatedCircleNavigator.prototype.componentDidUpdate = function (prevProps) {
    ...
    AnimatedCircleNavigator.prototype.render = function () {
        var _this = this;
    ...
    return AnimatedCircleNavigator;
}(React.Component));
exports.default = AnimatedCircleNavigator;
